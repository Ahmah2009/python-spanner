...
@pytest.mark.parametrize(
    u"client_class", [InstanceAdminClient, InstanceAdminAsyncClient]
)
...
def test_instance_admin_client_get_transport_class():
    ...
    transport = InstanceAdminClient.get_transport_class(u"grpc")
    assert transport == transports.InstanceAdminGrpcTransport
...
@pytest.mark.parametrize(
    ...
    [
        (InstanceAdminClient, transports.InstanceAdminGrpcTransport, u"grpc"),
        (
            InstanceAdminAsyncClient,
...
def test_instance_admin_client_client_options(
    ...
    with mock.patch.object(InstanceAdminClient, u"get_transport_class") as gtc:
...
@pytest.mark.parametrize(
    ...
    [
        (InstanceAdminClient, transports.InstanceAdminGrpcTransport, u"grpc", u"true"),
        (
            InstanceAdminAsyncClient,
            transports.InstanceAdminGrpcAsyncIOTransport,
            u"grpc_asyncio",
        ...
        (InstanceAdminClient, transports.InstanceAdminGrpcTransport, u"grpc", u"false"),
        (
            InstanceAdminAsyncClient,
            transports.InstanceAdminGrpcAsyncIOTransport,
            u"grpc_asyncio",
...
def test_instance_admin_client_client_options_from_dict():
    with mock.patch(
        u"google.cloud.spanner_admin_instance_v1.services.instance_admin.transports.InstanceAdminGrpcTransport.__init__"
    ) as grpc_transport:
...
def test_list_instance_configs(
    ...
    with mock.patch.object(
        type(client.transport.list_instance_configs), u"__call__"
    ) as call:
...
def test_list_instance_configs_flattened():
    ...
    with mock.patch.object(
        ...
        client.list_instance_configs(parent=u"parent_value",)
...
def test_list_instance_configs_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_instance_configs(
            spanner_instance_admin.ListInstanceConfigsRequest(), parent=u"parent_value",
        )
...
async def test_list_instance_configs_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_instance_configs(parent=u"parent_value",)
...
def test_list_instance_configs_pager():
    ...
    with mock.patch.object(
        ...
        call.side_effect = (
            ...
            spanner_instance_admin.ListInstanceConfigsResponse(
                instance_configs=[], next_page_token=u"def",
            ),
            spanner_instance_admin.ListInstanceConfigsResponse(
                instance_configs=[spanner_instance_admin.InstanceConfig(),],
                next_page_token=u"ghi",
            ),
            spanner_instance_admin.ListInstanceConfigsResponse(
                instance_configs=[
                    spanner_instance_admin.InstanceConfig(),
...
def test_get_instance_config(
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.get_instance_config), u"__call__"
    ) as call:
        # Designate an appropriate return value for the call.
        call.return_value = spanner_instance_admin.InstanceConfig(
            name=u"name_value", display_name=u"display_name_value",
        )
    ...
    assert response.display_name == u"display_name_value"
...
def test_get_instance_config_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_instance_config(name=u"name_value",)
...
def test_get_instance_config_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_instance_config(
            spanner_instance_admin.GetInstanceConfigRequest(), name=u"name_value",
        )
...
async def test_get_instance_config_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_instance_config(name=u"name_value",)
...
def test_list_instances(
    transport = u"grpc", request_type=spanner_instance_admin.ListInstancesRequest
):
    client = InstanceAdminClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.list_instances), u"__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_list_instances_flattened():
    ...
    with mock.patch.object(type(client.transport.list_instances), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_instances(parent=u"parent_value",)
...
def test_list_instances_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_instances(
            spanner_instance_admin.ListInstancesRequest(), parent=u"parent_value",
        )
...
async def test_list_instances_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_instances), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_instances(parent=u"parent_value",)
...
def test_list_instances_pager():
    ...
    with mock.patch.object(type(client.transport.list_instances), u"__call__") as call:
        ...
        call.side_effect = (
            ...
            spanner_instance_admin.ListInstancesResponse(
                instances=[], next_page_token=u"def",
            ),
            spanner_instance_admin.ListInstancesResponse(
                instances=[spanner_instance_admin.Instance(),], next_page_token=u"ghi",
            ),
            spanner_instance_admin.ListInstancesResponse(
                instances=[
                    spanner_instance_admin.Instance(),
...
async def test_list_instances_async_pager():
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
        type(client.transport.list_instances), u"__call__", new_callable=mock.AsyncMock
    ) as call:
        # Set the response to a series of pages.
        call.side_effect = (
            spanner_instance_admin.ListInstancesResponse(
...
def test_get_instance(
    transport = u"grpc", request_type=spanner_instance_admin.GetInstanceRequest
):
    client = InstanceAdminClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.get_instance), u"__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = spanner_instance_admin.Instance(
            name=u"name_value",
            config=u"config_value",
            display_name=u"display_name_value",
            node_count=1070,
            state=spanner_instance_admin.Instance.State.CREATING,
            endpoint_uris=[u"endpoint_uris_value"],
        )
    ...
    assert response.config == u"config_value"
    ...
    assert response.endpoint_uris == [u"endpoint_uris_value"]
...
def test_get_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.get_instance), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_instance(name=u"name_value",)
...
def test_get_instance_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_instance(
            spanner_instance_admin.GetInstanceRequest(), name=u"name_value",
        )
...
async def test_get_instance_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_instance), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_instance(name=u"name_value",)
...
def test_create_instance(
    transport = u"grpc", request_type=spanner_instance_admin.CreateInstanceRequest
):
    client = InstanceAdminClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.create_instance), u"__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_create_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.create_instance), u"__call__") as call:
        ...
        client.create_instance(
            ...
            instance_id=u"instance_id_value",
            instance=spanner_instance_admin.Instance(name=u"name_value"),
        )
        ...
        assert args[0].instance_id == u"instance_id_value"

        assert args[0].instance == spanner_instance_admin.Instance(name=u"name_value")
...
def test_update_instance(
    transport = u"grpc", request_type=spanner_instance_admin.UpdateInstanceRequest
):
    client = InstanceAdminClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.update_instance), u"__call__") as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name=u"operations/spam")
...
def test_update_instance_field_headers():
    ...
    request.instance.name = u"instance.name/value"
    ...
    # Establish that the field header was sent.
    _, _, kw = call.mock_calls[0]
    assert (u"x-goog-request-params", u"instance.name=instance.name/value",) in kw[
        u"metadata"
    ]
...
def test_update_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.update_instance), u"__call__") as call:
        ...
        client.update_instance(
            instance=spanner_instance_admin.Instance(name=u"name_value"),
            field_mask=gp_field_mask.FieldMask(paths=[u"paths_value"]),
        )
        ...
        assert args[0].field_mask == gp_field_mask.FieldMask(paths=[u"paths_value"])
...
def test_delete_instance(
    transport = u"grpc", request_type=spanner_instance_admin.DeleteInstanceRequest
):
    client = InstanceAdminClient(
        credentials=credentials.AnonymousCredentials(), transport=transport,
    )
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(type(client.transport.delete_instance), u"__call__") as call:
        # Designate an appropriate return value for the call.
...
def test_delete_instance_flattened():
    ...
    with mock.patch.object(type(client.transport.delete_instance), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.delete_instance(name=u"name_value",)
...
def test_delete_instance_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.delete_instance(
            spanner_instance_admin.DeleteInstanceRequest(), name=u"name_value",
        )
...
async def test_delete_instance_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_instance), u"__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_instance(name=u"name_value",)
...
def test_instance_admin_base_transport():
    ...
    with mock.patch(
        u"google.cloud.spanner_admin_instance_v1.services.instance_admin.transports.InstanceAdminTransport.__init__"
    ) as Transport:
    ...
    methods = (
        u"list_instance_configs",
        u"get_instance_config",
        u"list_instances",
        u"get_instance",
        u"create_instance",
        u"update_instance",
...
def test_instance_admin_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        u"google.cloud.spanner_admin_instance_v1.services.instance_admin.transports.InstanceAdminTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_instance_config_path():
    project = u"oyster"
    instance_config = u"nudibranch"

    expected = u"projects/{project}/instanceConfigs/{instance_config}".format(
...
def test_parse_instance_config_path():
    expected = {
        u"project": u"cuttlefish",
        u"instance_config": u"mussel",
    }
...
def test_client_withDEFAULT_CLIENT_INFO():
    ...
    with mock.patch.object(
        transports.InstanceAdminTransport, u"_prep_wrapped_messages"
    ) as prep:
        client = InstanceAdminClient(
